...
urlpatterns = [
    ...
    path('email-verify/', views.EmailVerifyCodeView.as_view(), name='email_verify'),
    ...
    path('verification/send-code/<int:pk>/', views.verification_send_code, name='verification_send_code'),
]
